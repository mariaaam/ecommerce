...
<div >
<img style={{height:"150px"}}  className="w-100"  src={require('../../images/grocery-banner.png')}/>
</div>
<div>
<img style={{height:"150px"}}  className="w-100"  src={require('../../images/grocery-banner-2.jpeg')}/>
</div>
   </div>
  </div>
